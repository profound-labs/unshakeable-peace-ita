...
\emph{samādhi}%
\pagenote{\emph{Samādhi}: l'energia mentale focalizzata nella concentrazione meditativa.}
...
In teoria la virtù viene per prima, poi viene samādhi e infine la
...
Virtù, samādhi e saggezza costituiscono il Sentiero del Buddha. Ma la
...
Questo livello di samādhi è un punto di arrivo. Il Buddha si fermò lì e
...
Praticare il Dhamma vuol dire mantenere la virtù, sviluppare samādhi e
